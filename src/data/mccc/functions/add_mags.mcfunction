...
execute if score $expdiff mccc matches 0 run function mccc:add_mags1
execute unless score $expdiff mccc matches 0 run function mccc:add_mags2
execute if score $r mccc matches 0 run function mccc:round_pack
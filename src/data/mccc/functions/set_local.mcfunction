...
execute if score $search1 mccc = $stackSize mccc run function mccc:tree/local_set
execute if score $search1 mccc < $stackSize mccc run function mccc:tree/local_copy
execute if score $search1 mccc < $stackSize mccc run function mccc:tree/templ_set
execute if score $search1 mccc < $stackSize mccc run function mccc:tree/local_paste
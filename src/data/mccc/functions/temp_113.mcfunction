scoreboard players operation $t287 mccc = $l0 mccc
...
execute store result storage mccc:main temps[-12] int 1 run scoreboard players get $t268 mccc
execute store result storage mccc:main temps[-13] int 1 run scoreboard players get $t269 mccc
execute store result storage mccc:main temps[-14] int 1 run scoreboard players get $t277 mccc
execute store result storage mccc:main temps[-15] int 1 run scoreboard players get $t278 mccc
...
scoreboard players operation $l0 mccc = $t287 mccc
...
data remove storage mccc:main temps[-1]
execute store result score $t268 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
execute store result score $t269 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
execute store result score $t277 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
execute store result score $t278 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]

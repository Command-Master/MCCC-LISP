scoreboard players operation $t298 mccc = $l3 mccc
...
scoreboard players operation $l0 mccc = $t298 mccc
...
scoreboard players operation $t299 mccc = $r0 mccc
scoreboard players operation $r0 mccc = $t299 mccc

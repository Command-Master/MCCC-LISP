scoreboard players operation $t325 mccc = $l0 mccc
scoreboard players operation $index mccc = $t325 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t326 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t327 mccc = $l1 mccc
...
execute store result storage mccc:main temps[-12] int 1 run scoreboard players get $t323 mccc
execute store result storage mccc:main temps[-13] int 1 run scoreboard players get $t324 mccc
...
scoreboard players operation $l0 mccc = $t326 mccc
scoreboard players operation $l1 mccc = $t327 mccc
...
data remove storage mccc:main temps[-1]
execute store result score $t323 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
execute store result score $t324 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
...
scoreboard players operation $t328 mccc = $r0 mccc
scoreboard players operation $t329 mccc = $t328 mccc
execute unless score $t329 mccc matches 0 run function mccc:temp_134

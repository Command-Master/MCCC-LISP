scoreboard players operation $t363 mccc = $l0 mccc
scoreboard players operation $index mccc = $t363 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t364 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t365 mccc = $l1 mccc
scoreboard players operation $index mccc = $t365 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t366 mccc = $value mccc
scoreboard players add $index mccc 1
...
execute store result storage mccc:main temps[-14] int 1 run scoreboard players get $t361 mccc
execute store result storage mccc:main temps[-15] int 1 run scoreboard players get $t362 mccc
...
scoreboard players operation $l0 mccc = $t364 mccc
scoreboard players operation $l1 mccc = $t366 mccc
function mccc:method_eq
...
data remove storage mccc:main temps[-1]
execute store result score $t361 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
execute store result score $t362 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
...
scoreboard players operation $t367 mccc = $r0 mccc
scoreboard players operation $t368 mccc = $t367 mccc
execute store result score $t368 mccc if score $t368 mccc matches 0
scoreboard players operation $t369 mccc = $t368 mccc
execute unless score $t369 mccc matches 0 run function mccc:temp_143

scoreboard players operation $t429 mccc = $l0 mccc
scoreboard players operation $index mccc = $t429 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t430 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t431 mccc = $l1 mccc
scoreboard players operation $index mccc = $t431 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t432 mccc = $value mccc
scoreboard players add $index mccc 1
...
scoreboard players operation $l0 mccc = $t430 mccc
scoreboard players operation $l1 mccc = $t432 mccc
function mccc:method_eqlist
...
scoreboard players operation $t433 mccc = $r0 mccc
scoreboard players operation $r0 mccc = $t433 mccc

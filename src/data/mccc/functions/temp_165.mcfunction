scoreboard players operation $t441 mccc = $l0 mccc
...
scoreboard players operation $l0 mccc = $t441 mccc
...
scoreboard players operation $t442 mccc = $r0 mccc
scoreboard players operation $t443 mccc = $t442 mccc
execute unless score $t443 mccc matches 0 run function mccc:temp_166

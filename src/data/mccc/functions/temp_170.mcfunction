scoreboard players operation $t451 mccc = $l1 mccc
scoreboard players operation $t452 mccc = $l0 mccc
scoreboard players operation $index mccc = $t452 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t453 mccc = $value mccc
scoreboard players add $index mccc 1
...
scoreboard players operation $l0 mccc = $t451 mccc
scoreboard players operation $l1 mccc = $t453 mccc
...
scoreboard players operation $t454 mccc = $r0 mccc
scoreboard players operation $l4 mccc = $t454 mccc

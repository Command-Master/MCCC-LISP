scoreboard players operation $t500 mccc = $l2 mccc
...
scoreboard players operation $l0 mccc = $t500 mccc
...
scoreboard players operation $t501 mccc = $r0 mccc
scoreboard players set $t502 mccc 4
scoreboard players operation $t503 mccc = $t502 mccc
execute store result score $t503 mccc unless score $t501 mccc = $t503 mccc
scoreboard players operation $t504 mccc = $t503 mccc
execute unless score $t504 mccc matches 0 run function mccc:temp_187

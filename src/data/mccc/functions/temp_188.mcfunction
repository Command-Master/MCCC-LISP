scoreboard players operation $t509 mccc = $l2 mccc
scoreboard players operation $index mccc = $t509 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t510 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t510 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t511 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t512 mccc = $l1 mccc
...
scoreboard players operation $l0 mccc = $t511 mccc
scoreboard players operation $l1 mccc = $t512 mccc
...
scoreboard players operation $t513 mccc = $r0 mccc
scoreboard players operation $l5 mccc = $t513 mccc

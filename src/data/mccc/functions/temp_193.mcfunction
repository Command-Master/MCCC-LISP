scoreboard players operation $t522 mccc = $l2 mccc
scoreboard players operation $index mccc = $t522 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t523 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t523 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t524 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t524 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t525 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t525 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t526 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t527 mccc = $l1 mccc
...
scoreboard players operation $l0 mccc = $t526 mccc
scoreboard players operation $l1 mccc = $t527 mccc
...
scoreboard players operation $t528 mccc = $r0 mccc
scoreboard players operation $r0 mccc = $t528 mccc

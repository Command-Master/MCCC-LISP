scoreboard players operation $t571 mccc = $l2 mccc
...
scoreboard players operation $l0 mccc = $t571 mccc
...
scoreboard players operation $t572 mccc = $r0 mccc
scoreboard players set $t573 mccc 2
scoreboard players operation $t574 mccc = $t573 mccc
execute store result score $t574 mccc unless score $t572 mccc = $t574 mccc
scoreboard players operation $t575 mccc = $t574 mccc
execute unless score $t575 mccc matches 0 run function mccc:temp_202

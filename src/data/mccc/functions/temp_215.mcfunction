scoreboard players operation $t648 mccc = $l2 mccc
scoreboard players operation $index mccc = $t648 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t649 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t649 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t650 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t650 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t651 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t652 mccc = $l1 mccc
...
scoreboard players operation $l0 mccc = $t651 mccc
scoreboard players operation $l1 mccc = $t652 mccc
...
scoreboard players operation $t653 mccc = $r0 mccc
scoreboard players operation $l5 mccc = $t653 mccc

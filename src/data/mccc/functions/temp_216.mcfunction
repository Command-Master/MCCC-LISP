scoreboard players set $t654 mccc 1073741826
scoreboard players operation $t655 mccc = $l2 mccc
scoreboard players operation $index mccc = $t655 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t656 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t656 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t657 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t657 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t658 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t659 mccc = $l5 mccc
...
scoreboard players operation $l0 mccc = $t654 mccc
scoreboard players operation $l1 mccc = $t658 mccc
scoreboard players operation $l2 mccc = $t659 mccc

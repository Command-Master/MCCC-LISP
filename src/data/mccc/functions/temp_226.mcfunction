scoreboard players operation $t710 mccc = $l2 mccc
...
scoreboard players operation $l0 mccc = $t710 mccc
...
scoreboard players operation $t711 mccc = $r0 mccc
scoreboard players set $t712 mccc 3
scoreboard players operation $t713 mccc = $t712 mccc
execute store result score $t713 mccc unless score $t711 mccc = $t713 mccc
scoreboard players operation $t719 mccc = $t713 mccc
execute if score $t719 mccc matches 0 run function mccc:temp_227
scoreboard players operation $t720 mccc = $t719 mccc
execute unless score $t720 mccc matches 0 run function mccc:temp_228

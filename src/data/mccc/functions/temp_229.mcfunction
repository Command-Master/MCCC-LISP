scoreboard players operation $t725 mccc = $l2 mccc
scoreboard players operation $index mccc = $t725 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t726 mccc = $value mccc
scoreboard players add $index mccc 1
...
scoreboard players operation $l0 mccc = $t726 mccc
function mccc:method_createlambda
...
scoreboard players operation $t727 mccc = $r0 mccc
scoreboard players operation $r0 mccc = $t727 mccc

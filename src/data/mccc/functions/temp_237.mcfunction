scoreboard players operation $t770 mccc = $l2 mccc
...
scoreboard players operation $l0 mccc = $t770 mccc
...
scoreboard players operation $t771 mccc = $r0 mccc
scoreboard players set $t772 mccc 4
scoreboard players operation $t773 mccc = $t772 mccc
execute store result score $t773 mccc unless score $t771 mccc = $t773 mccc
scoreboard players operation $t780 mccc = $t773 mccc
execute if score $t780 mccc matches 0 run function mccc:temp_238
scoreboard players operation $t787 mccc = $t780 mccc
execute if score $t787 mccc matches 0 run function mccc:temp_239
scoreboard players operation $t788 mccc = $t787 mccc
execute unless score $t788 mccc matches 0 run function mccc:temp_240

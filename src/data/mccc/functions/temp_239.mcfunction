scoreboard players operation $t781 mccc = $l2 mccc
scoreboard players operation $index mccc = $t781 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t782 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t782 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t783 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t783 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t784 mccc = $value mccc
scoreboard players add $index mccc 1
...
execute store result storage mccc:main temps[-30] int 1 run scoreboard players get $t780 mccc
...
scoreboard players operation $l0 mccc = $t784 mccc
function mccc:method_islist
...
data remove storage mccc:main temps[-1]
execute store result score $t780 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
...
scoreboard players operation $t785 mccc = $r0 mccc
scoreboard players operation $t786 mccc = $t785 mccc
execute store result score $t786 mccc if score $t786 mccc matches 0
scoreboard players operation $t787 mccc = $t786 mccc

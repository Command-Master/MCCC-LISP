scoreboard players operation $t793 mccc = $l2 mccc
scoreboard players operation $index mccc = $t793 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t794 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t794 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t795 mccc = $value mccc
scoreboard players add $index mccc 1
...
scoreboard players operation $l0 mccc = $t795 mccc
...
scoreboard players operation $t796 mccc = $r0 mccc
scoreboard players operation $l5 mccc = $t796 mccc

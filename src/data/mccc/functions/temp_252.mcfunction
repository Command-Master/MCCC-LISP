scoreboard players set $t836 mccc 1
scoreboard players set $t837 mccc 1
...
scoreboard players operation $l0 mccc = $t836 mccc
scoreboard players operation $l1 mccc = $t837 mccc
...
scoreboard players operation $t838 mccc = $r0 mccc
scoreboard players operation $l5 mccc = $t838 mccc

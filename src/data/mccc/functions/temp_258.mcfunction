scoreboard players operation $t859 mccc = $l7 mccc
scoreboard players operation $t860 mccc = $l5 mccc
scoreboard players operation $index mccc = $t860 mccc
function mccc:get_heap
scoreboard players operation $t861 mccc = $value mccc
...
scoreboard players operation $l0 mccc = $t859 mccc
scoreboard players operation $l1 mccc = $t861 mccc
...
scoreboard players operation $t862 mccc = $r0 mccc
scoreboard players operation $r0 mccc = $t862 mccc

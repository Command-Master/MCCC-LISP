scoreboard players operation $t922 mccc = $l2 mccc
scoreboard players operation $index mccc = $t922 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t923 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t923 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t924 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t925 mccc = $l1 mccc
...
scoreboard players operation $l0 mccc = $t924 mccc
scoreboard players operation $l1 mccc = $t925 mccc
...
scoreboard players operation $t926 mccc = $r0 mccc
scoreboard players operation $l6 mccc = $t926 mccc

scoreboard players operation $t927 mccc = $l2 mccc
scoreboard players operation $index mccc = $t927 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t928 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t928 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t929 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t929 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t930 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t931 mccc = $l1 mccc
...
scoreboard players operation $l0 mccc = $t930 mccc
scoreboard players operation $l1 mccc = $t931 mccc
...
scoreboard players operation $t932 mccc = $r0 mccc
scoreboard players operation $l7 mccc = $t932 mccc

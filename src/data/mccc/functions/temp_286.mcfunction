scoreboard players operation $t986 mccc = $l8 mccc
...
scoreboard players operation $l0 mccc = $t986 mccc
function mccc:method_createint
...
scoreboard players operation $t987 mccc = $r0 mccc
scoreboard players operation $r0 mccc = $t987 mccc

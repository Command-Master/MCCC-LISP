scoreboard players operation $t1006 mccc = $l2 mccc
...
scoreboard players operation $l0 mccc = $t1006 mccc
...
scoreboard players operation $t1007 mccc = $r0 mccc
scoreboard players set $t1008 mccc 3
scoreboard players operation $t1009 mccc = $t1008 mccc
execute store result score $t1009 mccc unless score $t1007 mccc = $t1009 mccc
scoreboard players operation $t1010 mccc = $t1009 mccc
execute unless score $t1010 mccc matches 0 run function mccc:temp_292

scoreboard players operation $t1015 mccc = $l2 mccc
scoreboard players operation $index mccc = $t1015 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t1016 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t1016 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t1017 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t1018 mccc = $l1 mccc
...
scoreboard players operation $l0 mccc = $t1017 mccc
scoreboard players operation $l1 mccc = $t1018 mccc
...
scoreboard players operation $t1019 mccc = $r0 mccc
scoreboard players operation $l6 mccc = $t1019 mccc

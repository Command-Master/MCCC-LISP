scoreboard players operation $t1020 mccc = $l2 mccc
scoreboard players operation $index mccc = $t1020 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t1021 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t1021 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t1022 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t1022 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t1023 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t1024 mccc = $l1 mccc
...
scoreboard players operation $l0 mccc = $t1023 mccc
scoreboard players operation $l1 mccc = $t1024 mccc
...
scoreboard players operation $t1025 mccc = $r0 mccc
scoreboard players operation $l7 mccc = $t1025 mccc

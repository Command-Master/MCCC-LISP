scoreboard players operation $t1026 mccc = $l6 mccc
scoreboard players operation $t1027 mccc = $l7 mccc
...
scoreboard players operation $l0 mccc = $t1026 mccc
scoreboard players operation $l1 mccc = $t1027 mccc
...
scoreboard players operation $t1028 mccc = $r0 mccc
scoreboard players operation $t1029 mccc = $t1028 mccc
execute if score $t1029 mccc matches 0 run function mccc:temp_298
execute unless score $t1029 mccc matches 0 run function mccc:temp_296

scoreboard players operation $t1065 mccc = $l2 mccc
scoreboard players operation $index mccc = $t1065 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t1066 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t1066 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t1067 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t1068 mccc = $l1 mccc
...
scoreboard players operation $l0 mccc = $t1067 mccc
scoreboard players operation $l1 mccc = $t1068 mccc
...
scoreboard players operation $t1069 mccc = $r0 mccc
scoreboard players operation $l6 mccc = $t1069 mccc

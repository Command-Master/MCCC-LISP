scoreboard players operation $t1081 mccc = $l2 mccc
...
execute store result storage mccc:main temps[-30] int 1 run scoreboard players get $t1080 mccc
...
scoreboard players operation $l0 mccc = $t1081 mccc
...
data remove storage mccc:main temps[-1]
execute store result score $t1080 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
...
scoreboard players operation $t1082 mccc = $r0 mccc
scoreboard players set $t1083 mccc 2
scoreboard players operation $t1084 mccc = $t1083 mccc
execute store result score $t1084 mccc unless score $t1082 mccc = $t1084 mccc
scoreboard players operation $t1085 mccc = $t1084 mccc

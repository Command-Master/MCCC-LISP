scoreboard players operation $t1101 mccc = $l6 mccc
scoreboard players operation $index mccc = $t1101 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t1102 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t1102 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t1103 mccc = $value mccc
scoreboard players add $index mccc 1
...
execute store result storage mccc:main temps[-30] int 1 run scoreboard players get $t1096 mccc
execute store result storage mccc:main temps[-31] int 1 run scoreboard players get $t1097 mccc
...
scoreboard players operation $l0 mccc = $t1103 mccc
...
data remove storage mccc:main temps[-1]
execute store result score $t1096 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
execute store result score $t1097 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
...
scoreboard players operation $t1104 mccc = $r0 mccc
scoreboard players operation $r0 mccc = $t1104 mccc

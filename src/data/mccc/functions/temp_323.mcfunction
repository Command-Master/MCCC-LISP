scoreboard players operation $t1146 mccc = $l2 mccc
scoreboard players operation $index mccc = $t1146 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t1147 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t1147 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t1148 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t1149 mccc = $l1 mccc
...
scoreboard players operation $l0 mccc = $t1148 mccc
scoreboard players operation $l1 mccc = $t1149 mccc
...
scoreboard players operation $t1150 mccc = $r0 mccc
scoreboard players operation $l6 mccc = $t1150 mccc

scoreboard players operation $t1151 mccc = $l2 mccc
scoreboard players operation $index mccc = $t1151 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t1152 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t1152 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t1153 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t1153 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t1154 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t1155 mccc = $l1 mccc
...
scoreboard players operation $l0 mccc = $t1154 mccc
scoreboard players operation $l1 mccc = $t1155 mccc
...
scoreboard players operation $t1156 mccc = $r0 mccc
scoreboard players operation $l7 mccc = $t1156 mccc

scoreboard players operation $t1210 mccc = $l2 mccc
...
scoreboard players operation $l0 mccc = $t1210 mccc
...
scoreboard players operation $t1211 mccc = $r0 mccc
scoreboard players set $t1212 mccc 2
scoreboard players operation $t1213 mccc = $t1212 mccc
execute store result score $t1213 mccc unless score $t1211 mccc = $t1213 mccc
scoreboard players operation $t1214 mccc = $t1213 mccc
execute unless score $t1214 mccc matches 0 run function mccc:temp_338

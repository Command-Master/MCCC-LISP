scoreboard players operation $t1219 mccc = $l2 mccc
scoreboard players operation $index mccc = $t1219 mccc
scoreboard players add $index mccc 1
function mccc:get_heap
scoreboard players operation $t1220 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $index mccc = $t1220 mccc
scoreboard players add $index mccc 0
function mccc:get_heap
scoreboard players operation $t1221 mccc = $value mccc
scoreboard players add $index mccc 1
scoreboard players operation $t1222 mccc = $l1 mccc
...
scoreboard players operation $l0 mccc = $t1221 mccc
scoreboard players operation $l1 mccc = $t1222 mccc
...
scoreboard players operation $t1223 mccc = $r0 mccc
scoreboard players operation $l6 mccc = $t1223 mccc

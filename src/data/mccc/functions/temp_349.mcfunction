scoreboard players operation $t1262 mccc = $l2 mccc
...
scoreboard players operation $l0 mccc = $t1262 mccc
...
scoreboard players operation $t1263 mccc = $r0 mccc
scoreboard players set $t1264 mccc 2
scoreboard players operation $t1265 mccc = $t1264 mccc
execute store result score $t1265 mccc unless score $t1263 mccc = $t1265 mccc
scoreboard players operation $t1266 mccc = $t1265 mccc
execute unless score $t1266 mccc matches 0 run function mccc:temp_350

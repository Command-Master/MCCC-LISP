scoreboard players operation $t1331 mccc = $l2 mccc
...
scoreboard players operation $l0 mccc = $t1331 mccc
...
scoreboard players operation $t1332 mccc = $r0 mccc
scoreboard players set $t1333 mccc 2
scoreboard players operation $t1334 mccc = $t1333 mccc
execute store result score $t1334 mccc unless score $t1332 mccc = $t1334 mccc
scoreboard players operation $t1335 mccc = $t1334 mccc
execute unless score $t1335 mccc matches 0 run function mccc:temp_364

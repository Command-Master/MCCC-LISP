scoreboard players operation $t1384 mccc = $l0 mccc
...
scoreboard players operation $l0 mccc = $t1384 mccc
function mccc:method_parseint
...
scoreboard players operation $t1385 mccc = $r0 mccc
scoreboard players operation $r0 mccc = $t1385 mccc

...
execute store result storage mccc:main temps[-33] int 1 run scoreboard players get $t1392 mccc
execute store result storage mccc:main temps[-34] int 1 run scoreboard players get $t1393 mccc
...
data remove storage mccc:main temps[-1]
execute store result score $t1392 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
execute store result score $t1393 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
...
scoreboard players operation $t1394 mccc = $r0 mccc
scoreboard players operation $l0 mccc = $t1394 mccc
function mccc:temp_389

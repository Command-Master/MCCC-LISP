scoreboard players operation $t1396 mccc = $l0 mccc
...
scoreboard players operation $l0 mccc = $t1396 mccc
...
scoreboard players operation $t1397 mccc = $r0 mccc
scoreboard players operation $r0 mccc = $t1397 mccc

scoreboard players operation $t1408 mccc = $l0 mccc
...
scoreboard players operation $l0 mccc = $t1408 mccc
function mccc:method_createstr
...
scoreboard players operation $t1409 mccc = $r0 mccc
scoreboard players operation $t2 mccc = $t1409 mccc

scoreboard players operation $t81 mccc = $0 mccc
...
scoreboard players operation $l0 mccc = $t81 mccc
...
scoreboard players operation $t82 mccc = $r0 mccc
scoreboard players operation $l1 mccc = $t82 mccc

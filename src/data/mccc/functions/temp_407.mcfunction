scoreboard players set $t1423 mccc 363
...
execute store result storage mccc:main temps[-28] int 1 run scoreboard players get $t1420 mccc
...
scoreboard players operation $l0 mccc = $t1423 mccc

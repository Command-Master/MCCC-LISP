scoreboard players operation $t87 mccc = $1 mccc
...
scoreboard players operation $l0 mccc = $t87 mccc
...
scoreboard players operation $t88 mccc = $r0 mccc
scoreboard players operation $l1 mccc = $t88 mccc

scoreboard players operation $t100 mccc = $2 mccc
...
scoreboard players operation $l0 mccc = $t100 mccc
...
scoreboard players operation $t101 mccc = $r0 mccc
scoreboard players operation $l1 mccc = $t101 mccc

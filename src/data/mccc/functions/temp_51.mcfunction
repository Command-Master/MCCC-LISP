scoreboard players operation $t106 mccc = $3 mccc
...
scoreboard players operation $l0 mccc = $t106 mccc
function mccc:method_createatom
...
scoreboard players operation $t107 mccc = $r0 mccc
scoreboard players operation $l1 mccc = $t107 mccc

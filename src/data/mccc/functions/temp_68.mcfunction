...
scoreboard players operation $t154 mccc = $r0 mccc
scoreboard players set $t155 mccc 41
scoreboard players operation $t156 mccc = $t155 mccc
execute store result score $t156 mccc if score $t154 mccc = $t156 mccc
scoreboard players operation $t157 mccc = $t156 mccc
execute unless score $t157 mccc matches 0 run function mccc:temp_69

scoreboard players operation $t160 mccc = $l2 mccc
scoreboard players set $t161 mccc 0
scoreboard players operation $t162 mccc = $t161 mccc
scoreboard players operation $t162 mccc *= $0 mccc
...
execute store result storage mccc:main temps[-10] int 1 run scoreboard players get $t152 mccc
execute store result storage mccc:main temps[-11] int 1 run scoreboard players get $t153 mccc
execute store result storage mccc:main temps[-12] int 1 run scoreboard players get $t161 mccc
...
scoreboard players operation $l0 mccc = $t160 mccc
scoreboard players operation $l1 mccc = $t162 mccc
...
data remove storage mccc:main temps[-1]
execute store result score $t152 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
execute store result score $t153 mccc run data get storage mccc:main temps[-1]
data remove storage mccc:main temps[-1]
...
scoreboard players operation $t163 mccc = $r0 mccc
scoreboard players operation $l3 mccc = $t163 mccc

scoreboard players operation $t172 mccc = $l0 mccc
...
scoreboard players operation $l0 mccc = $t172 mccc
...
scoreboard players operation $t173 mccc = $r0 mccc
scoreboard players operation $r0 mccc = $t173 mccc

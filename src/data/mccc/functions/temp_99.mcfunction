scoreboard players operation $t254 mccc = $l2 mccc
...
scoreboard players operation $l0 mccc = $t254 mccc
...
scoreboard players operation $t255 mccc = $r0 mccc
scoreboard players operation $r0 mccc = $t255 mccc
